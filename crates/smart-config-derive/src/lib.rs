...
//!
//! - [Macro reference](https://docs.rs/smart-config/0.4.0-pre.5/smart_config/_docs/derive_ref/) <!-- x-release-please-version -->
//! - [Examples of usage](https://docs.rs/smart-config/0.4.0-pre.5/smart_config/_docs/derive_examples/) <!-- x-release-please-version -->

// Documentation settings
#![doc(html_root_url = "https://docs.rs/smart-config-derive/0.4.0-pre.5")] // x-release-please-version
// General settings
#![recursion_limit = "128"]
